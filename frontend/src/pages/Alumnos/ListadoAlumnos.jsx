                    ...
                    <tr key={index} className="hover:bg-blue-50/30 transition-colors">
                      ...
                      <td className="p-4">
                        <div className="flex items-center justify-center gap-2">
                          <button className="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors border border-transparent hover:border-blue-100" title="Ver Kárdex">
          ...
          <div className="flex items-center justify-between p-4 border-t border-gray-200 bg-white">
            ...
            <div className="flex gap-1 items-center">
              <button 
                ...
                disabled={pagina === 1}
                className="p-1.5 border border-gray-300 rounded hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-gray-600"
              >
